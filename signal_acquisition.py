...
def export(scan_data, start_time, scan_rate):
    ...
    scan_times = [(start_time/scan_rate)*i for i in range(len(scan_data['Channel 1']))]
    ...
    print(len(scan_times))
    print(len(scan_data['Channel 1']))
    print(len(scan_data['Channel 2']))
